...
<body>
        ...
        <div class="container">
            <div class="style-banner mx-auto">
                ...
                <div class="home-form-w3ls mt-5">
                  <ul>
                      <li> <button><a href="login.aspx">Login</a></button></li>
                      <li> <button><a href="KayitOl.aspx">Register</a></button></li>
        ...
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="row">
                <div class="col-lg-6 text-center">
                    <img src="web/images/about.jpg" alt="about" class="img-fluid mt-4" />
                </div>
    ...
    <div class="middlesection-w3pvt py-sm-5 pt-sm-0 pt-5 mt-5" id="stats">
        ...
        <div class="property-paper">
            <img src="web/images/img3.png" alt="" class="img-fluid agents-w3" />
        </div>
    </div>
    <!-- //stats section -->
                    ...
                    <div class="card">
                        <div class="card-header m-0">
                            <h5 class="blog-title card-title m-0">
                                <a href="web/single.html">Cras ultricies ligula sed.</a>
                            </h5>
                        </div>
                        <div class="card-body">
    ...
    <div class="gallery-cont text-center pb-5" id="gallery">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal7"><img src="web/images/g7.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal8"><img src="web/images/g8.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal9"><img src="web/images/g9.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <!-- gallery popups -->
            <!-- popup-->
            ...
            <div id="gal7" class="pop-overlay animate">
                <div class="popup">
                    <img src="web/images/g7.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal8" class="pop-overlay animate">
                <div class="popup">
                    <img src="web/images/g8.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal9" class="pop-overlay animate">
                <div class="popup">
                    <img src="web/images/g9.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
    ...
    <section class="clients py-5" id="testi">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="feedback-info text-center">
                ...
                <img src="web/images/te1.jpg" alt=" " class="img-fluid mt-5">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group"> 
                                 <asp:TextBox ID="tboxinisim" runat="server" class="form-control" placeholder="First Name"></asp:TextBox>
                                </div>
                                <div class="form-group"> 
                                   <asp:TextBox ID="tboxinlastname" runat="server" class="form-control" placeholder="Last Name"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group"> 
                                   <asp:TextBox ID="tboxphone" runat="server" class="form-control"  placeholder="Mobile Number"></asp:TextBox>
                                </div>
                                <div class="form-group"> 
                                    <asp:TextBox ID="tboxmesaj" runat="server" class="form-control" placeholder="Your Message" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                        </div> 
                        <asp:Button ID="btnsub" runat="server" Text="Submit" class="btn_apt btn" OnClick="btnsub_Click" />
                    </form>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-4 footer-grid mt-lg-0 mt-4">
                    <div class="footer-logo">
                        <h2 class="text-lg-center text-center">
                            <a class="logo text-wh font-weight-bold" href="web/index.html">
                                My School</a>
                        </h2>
                    </div>
                </div>
