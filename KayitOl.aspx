            ...
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            <li><a href="web/images/index.html">Home</a></li>
                            <li><a href="web/images/index.html">About</a></li>
                            <li><a href="web/images/index.html">Join Now</a></li>
                            <li>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="tboxname" runat="server" class="form-control" placeholder="your name"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Email</label>
                        
                            <asp:TextBox ID="tboxmail" runat="server" class="form-control" placeholder="loremipsum@email.com"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Password</label>
                        <asp:TextBox ID="tboxpassword" runat="server"  class="form-control" placeholder="*****" TextMode="Password"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Enter Your City</label>
                        <asp:TextBox ID="tboxcity" runat="server" class="form-control" placeholder="City"></asp:TextBox>
                    </div>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Submit" class="btn button-style-w3" OnClick="Button1_Click"/>
                </form>
            </div>
            <!-- //register -->
        </div>
